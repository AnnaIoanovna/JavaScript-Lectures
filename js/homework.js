...
// function namesConcatenator(array) {
...
// console.log (namesConcatenator({firstName: "Jon", lastName:"Smitt", age: 25, gender:"man"}))

// function getBorderNumbers(arrayOfNumber, takeForm) {
// 	if (takeForm == "first") {
// 		return arrayOfNumber.slice(0, 2);
// 	}
// 	if (takeForm == "last") {
// 		return arrayOfNumber.slice(-2);
// 	}
// }
// console.log(getBorderNumbers([6,4,33,74,2,5,7], "last"));

function getTotalPrice(arrayOfProducts) {
	arrayOfProducts.map(function(elem){
		if (elem.inCart == true) 
		var summ = summ + parseFloat(n$); 
	})
	return summ;
}
arrayOfProducts = {name: "dog", price: 5$, inCart:true};
console.log(getTotalPrice(arrayOfProducts));